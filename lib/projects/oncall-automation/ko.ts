...
export const oncallAutomationKo: Project = {
  ...
  title: "프론트엔드 On-Call 프로세스 자동화",
  period: "2025년 10월",
  role: "비효율 식별, 자동화 설계·구현, 팀 도입 주도",
  summary:
    "여러 플랫폼에 흩어져 있던 On-Call 업무를 하나의 Jira 보드로 통합하고, 종료 리포트 작성을 자동화. 리포트 작성 시간을 기존의 약 1/3 수준으로 줄였고, On-Call 담당자가 할당된 이슈에 집중할 수 있는 환경을 만듦.",
  background: {
    content: [
      "FE On-Call 업무는 접수, 리포트, 인수인계 전반에 비효율이 조용히 누적되어 있는 상태였음. 비효율을 해결하기보다 매번 수동으로 처리하며 일해 옴.",
    ],
  },
  problem: {
    content: [
      "**분산된 버그 접수:** On-Call 담당자가 Shakebug과 Slack을 따로 모니터링하면서, 팀 관련 버그를 매번 수동으로 골라내야 했음.",
      "**수기 인수인계 리포트:** 종료 리포트 작성을 위해 New Relic, OpsGenie, Shakebug, Slack 등을 일일이 확인하고 요약을 직접 작성해야 했음.",
      "**허술한 미해결 업무 인계:** 이전 On-Call 담당자가 미완료 업무 리스트를 직접 작성해 다음 차례에 넘겼음. 항목 누락이 잦았고, 빠진 항목은 누구도 인지하지 못한 채 몇 달간 방치되기도 했음.",
    ],
  },
  keyDecisions: [
    {
      ...
      description: [
        ...
        "원본 Shakebug 링크와 Slack 스레드 링크를 Jira 티켓에 보존해 맥락 유지. On-Call 담당자는 Jira 보드 한 곳만 모니터링하면 됨.",
      ],
      media: [
        {
          type: "image",
    ...
    {
      title: "LLM 기반 인수인계 리포트와 미해결 업무 자동 재배정",
      description: [
        ...
        "미해결 Jira 티켓은 자동으로 다음 On-Call 담당자에게 재배정 — 항목 누락의 원인이었던 수동 리스트 작성 단계 자체를 없앰.",
      ],
      media: [
        {
          type: "image",
          src: "/projects/oncall-automation/ko/report-flow.svg",
          alt: "종료 리포트 자동 플로우: 4개 플랫폼이 n8n과 LLM으로 모여 Slack 리포트 생성 및 티켓 자동 재배정",
        },
        {
          type: "image",
  ...
  result: {
    content: [
      "**시간 절감:** 리포트 작성 시간을 약 1/3 수준으로 단축 (약 67% 감소).",
      "**집중도 향상:** On-Call 담당자가 단일 보드에서 할당된 티켓만 관리. 더 이상 Shakebug, Slack을 오가며 플랫폼별로 모니터링하고 팀 관련 버그를 수동으로 필터링할 필요가 없어짐.",
      "**업무 누락 제거:** 모든 미해결 티켓이 시스템에서 자동 추적되고 On-Call 종료 시 다음 담당자에게 자동 재배정 — 불안정한 수동 리스트를 완전히 대체.",
      "**다른 팀 도입:** 버그 라우팅 컨셉이 QA 팀의 관심을 끔. QA 팀이 n8n 워크플로우로 유사한 버전을 직접 구축 — 공용 Slack 채널의 태그 필터링된 버그를 팀별 채널로 라우팅하면서, 원본 스레드 링크를 보존해 On-Call 담당자가 신고자와 빠르게 이어서 대화할 수 있도록 설계.",
    ],
  },
};
