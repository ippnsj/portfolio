...
export const aiRecipeSearchKo: Project = {
  ...
  title: "AI 레시피 검색·재료 자동 추출 기능",
  period: "2025년 10월",
  role: "UX 개선점 식별, 기획·설계·구현, 내부 데모 진행",
  summary:
    "레시피를 찾으러 외부 앱으로 나갔다가 자사 앱으로 돌아와 재료를 하나씩 검색해야 했던 사용자 흐름을, 앱 내 단일 흐름(레시피 검색 → 재료 자동 추출 → 멀티 검색 진입)으로 통합한 PoC. 자발적으로 기획·설계·구현하고 내부 데모까지 진행함.",
  background: {
    content: [
  ...
  keyDecisions: [
    ...
    },
    {
      ...
      description: [
        ...
        "멀티 검색은 자동화 편의성(수동 검색 없이)을 살리면서 사용자의 선택권은 그대로 보장.",
      ],
      media: [
        {
          type: "image",
  ...
  result: {
    content: [
      "팀 호평: 프로덕트·디자인 팀의 긍정적 피드백으로 ML 팀과 협업 논의까지 진행.",
      "한계: 조직 리소스 사정으로 프로덕션 미진입.",
      "기대 효과: 자사 앱 내 단일 흐름으로 외부 앱 의존을 없애고, 반복적인 재료 검색 없이 상품 선택에만 집중 가능.",
    ],
    media: [
      {
        type: "video",
