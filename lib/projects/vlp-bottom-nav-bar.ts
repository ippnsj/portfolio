...
export const vlpDynamicBottomNavBar: Project = {
  ...
  problem: {
    ...
    media: [
      {
        type: "image",
        src: "/projects/vlp-bottom-nav-bar/before-after-structure.svg",
  ...
  keyDecisions: [
    {
      ...
      description: [
        ...
        "`route` — for content that is already reachable via an existing route (e.g., a deeplink). The Nav Bar opens that route as a tab. No new widget code, no new route code, no FE release — just BE wiring an existing route into the contract. The category PLP fits here: it already had a deeplink.",
      ...
      media: [
        {
          type: "image",
          src: "/projects/vlp-bottom-nav-bar/vlp-be-driven-tab-contract.svg",
    ...
    },
    {
      ...
      media: [
        {
          type: "image",
          src: "/projects/vlp-bottom-nav-bar/scroll-logic.svg",
    ...
    },
    {
      ...
      description: [
        ...
        "I proposed bundling the Rider migration in. It was already planned for later, and would have required auditing the same call sites — doing both at once avoided repeating the audit. The migration carried beyond the project, too: I completed it solo across all remaining screens in the G&R tribe, leaving the navigation layer consistent.",
      ],
    },
  ],
  result: {
